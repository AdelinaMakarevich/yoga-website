...
function TitleCard() {
    return (
      ...
      <a href="https://vk.me/laramirosh" target="_blank" title="ВКонтакте" rel="noreferrer" className={styles.iconVK}>
      ...
      <a href="https://t.me/jogaginekolog" target="_blank" title="Телеграм канал Йога с гинекологом" rel="noreferrer" className={styles.iconTelegram}>
