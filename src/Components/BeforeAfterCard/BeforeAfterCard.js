    ...
    return (
      <section className={styles.container}>
        <p className={styles.text}>Вы думаете, что нужно вырастить детей, дать им образование, доработать до пенсии, 
          ...
          воплотите в жизнь все свои мечты! Оглянитесь вокруг! <br /> Кому нужны старые и больные люди, 
          если они сами себе не нужны! <br /> Меняются времена года, а здоровье и молодость уходит, пока 
          мы размышляем о своей счастливой жизни на пенсии! <br /> Дети повторят вашу жизнь и тоже будут ждать чуда в новый год!</p>
